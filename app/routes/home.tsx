  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-6 pt-12 pb-8 space-y-6">
        <h1 className="text-5xl h-30 my-10 font-bold text-center bg-linear-to-r from-blue-600 via-green-500 to-indigo-400 text-transparent bg-clip-text animate-pulse">
          Welcome to the Spaghettarium
        </h1>

        {/* Chat window placeholder */}
        <div className="rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 flex flex-col overflow-hidden">
          <div className="flex-1 min-h-36 flex items-center justify-center px-6 py-8">
      ...
      <div className="container mx-auto px-6 pb-12">
        <h2 className="text-lg font-semibold mb-3">Script Library</h2>
        {scripts.length === 0 ? (
